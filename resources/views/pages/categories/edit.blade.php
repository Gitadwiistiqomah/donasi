...
@section('content')
    <div class="py-4">
        <h3 class="fw-bold mb-2 pb-2 border-bottom">Update Kategori</h3>
        ...
        <form action="{{route('admin.categories.update', $categories->id) }}" method="POST">
            ...
            <div class="form-group mb-2">
                ...
                <input type="text" name="slug" id="slug" value="{{ $categories->slug }}" class="form-control @error('slug') is-invalid  @enderror"/>
